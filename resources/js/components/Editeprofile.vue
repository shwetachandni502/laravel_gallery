         ...
         <div class="row pl-3" >
            ...
            <div class="form-group">
				...
				<input type="file" 
					   ...
					   >
                        <p v-if="record.path">
                            <img :src="record.path" width="100px" class="my-3" />
                            </p>
            ...
            <button @click="profileupdate" class="btn btn-info my-3">
                Update Profile
            </button>
...
export default ({
    ...
    methods: {
          onChange(e) {
                ...
                reader.onload = (er) => {
                    this.record.path = er.target.result;
                    
                }
                reader.readAsDataURL(e.target.files[0]);
                console.log( this.record.path,"new")
                  }
    ...
    //   this.setup()
        ...
        this.record.path=this.claims.path;
        this.record.img=this.claims.img;
